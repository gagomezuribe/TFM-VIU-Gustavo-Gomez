...
Original file is located at
    https://colab.research.google.com/drive/1laMJkp8vrDGZA2mlNWhjVaKYPu4B0FCN

MODELO PRE ENTRENADO RESNET - FINE TUNING PCAM
Dataset: Patch Camelyon
Fuente del modelo: keras_hub
Modelo: RESNET TF preentreenada Imagenet 21K
...
print(datetime.datetime.now().strftime("Fecha: %d/%m/%Y, Hora: %H:%M:%S"))

image_classifier.save_to_preset(base_folder+"/pcam_resnet_v1")